# Generated by Django 5.2.1 on 2025-05-15 17:36
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('imagem', models.ImageField(default='cursos/padrao.jpg', upload_to='cursos/')),
            ],
            options={
                'db_table': 'curso',
            },
        ...
        migrations.CreateModel(
            name='Arquivo',
            fields=[
                ('id_arquivo', models.AutoField(db_column='ID_Arquivo', primary_key=True, serialize=False)),
                ('tipo', models.CharField(db_column='Tipo', max_length=20)),
                ('url_arquivo', models.CharField(db_column='URL_Arquivo', max_length=45)),
                ('descricao', models.CharField(blank=True, db_column='Descricao', max_length=45, null=True)),
